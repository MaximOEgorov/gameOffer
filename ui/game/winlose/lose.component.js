...
export function Lose(parentEl) {
    subscribe(() => {
        updateLose(containerElement);
    })
...
function updateLose(containerElement) {
    if (data.gameStatus === GAME_STATUSES.lose) {
...
function svgEl() {
    return '<svg xmlns="http://www.w3.org/2000/svg" width="300" height="427" viewBox="0 -100 300 527" y="400" fill="none">\n' +
        ...
        '   font-size: 48px;line-height: 1em;padding:0;margin:0;background-color: white;color: #3676BC;text-align:center">You Lose!</p></foreignObject>\n' +
        ...
        '   font-size: 18px;line-height: 24px;padding:0;margin:0;background-color: white;color: #3676BC;text-align:center">You\'ll be lucky next time</p></foreignObject>\n' +
        '</svg>';
}
